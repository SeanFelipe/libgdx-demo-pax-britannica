...
class GameScreen ( game: Game, playerList: Array[Integer], cpuList: Array[Integer] ) extends DefaultScreen ( game ) with InputProcessor {
    ...
    if(numPlayers==1) {
        val touchAreaP1 = new BoundingBox(new Vector3(-((this.width-800)/2), -((this.height-480)/2), 0),new Vector3(-((this.width-800)/2)+(this.width), -((this.height-480)/2)+this.height, 0))
    } else if(numPlayers == 2) {
        val touchAreaP1 = new BoundingBox(new Vector3(-((this.width-800)/2), -((this.height-480)/2), 0),new Vector3(-((this.width-800)/2)+(this.width/2), -((this.height-480)/2)+this.height, 0))
        val touchAreaP2 = new BoundingBox(new Vector3(-((this.width-800)/2)+(this.width/2), -((this.height-480)/2), 0),new Vector3(-((this.width-800)/2)+this.width, -((this.height-480)/2)+this.height, 0))
    } else if(numPlayers == 3) {
        val touchAreaP1 = new BoundingBox(new Vector3(-((this.width-800)/2), -((this.height-480)/2), 0),new Vector3(-((this.width-800)/2)+(this.width/2), -((this.height-480)/2)+(this.height/2), 0))
        ...
        val touchAreaP3 = new BoundingBox(new Vector3(-((this.width-800)/2)+(this.width/2), -((this.height-480)/2), 0),new Vector3(-((this.width-800)/2)+this.width, -((this.height-480)/2)+this.height, 0))
    } else if(numPlayers == 4) {
        val touchAreaP1 = new BoundingBox(new Vector3(-((this.width-800)/2), -((this.height-480)/2), 0),new Vector3(-((this.width-800)/2)+(this.width/2), -((this.height-480)/2)+(this.height/2), 0))
        val touchAreaP2 = new BoundingBox(new Vector3(-((this.width-800)/2), -((this.height-480)/2)+(this.height/2), 0),new Vector3(-((this.width-800)/2)+(this.width/2), -((this.height-480)/2)+this.height, 0))
        val touchAreaP3 = new BoundingBox(new Vector3(-((this.width-800)/2)+(this.width/2), -((this.height-480)/2), 0),new Vector3(-((this.width-800)/2)+this.width, -((this.height-480)/2)+(this.height/2), 0))
        val touchAreaP4 = new BoundingBox(new Vector3(-((this.width-800)/2)+(this.width/2), -((this.height-480)/2)+(this.height/2), 0),new Vector3(-((this.width-800)/2)+this.width, -((this.height-480)/2)+this.height, 0))
    }
    ...
    if(playerList.size>0 && playerList.get(0)==1) {
        val p1 = Resources.getInstance().factoryP1Small
    } else if(playerList.size>0 && playerList.get(0)==2) {
        val p1 = Resources.getInstance().factoryP2Small
    } else if(playerList.size>0 && playerList.get(0)==3) {
        val p1 = Resources.getInstance().factoryP3Small
    } else if(playerList.size>0 && playerList.get(0)==4) {
        val p1 = Resources.getInstance().factoryP4Small		
    }

    if(playerList.size>1 && playerList.get(1)==1) {
        val p2 = Resources.getInstance().factoryP1Small
    } else if(playerList.size>1 && playerList.get(1)==2) {
        val p2 = Resources.getInstance().factoryP2Small
    } else if(playerList.size>1 && playerList.get(1)==3) {
        val p2 = Resources.getInstance().factoryP3Small
    } else if(playerList.size>1 && playerList.get(1)==4) {
        val p2 = Resources.getInstance().factoryP4Small		
    }

    if(playerList.size>2 && playerList.get(2)==1) {
        val p3 = Resources.getInstance().factoryP1Small
    } else if(playerList.size>2 && playerList.get(2)==2) {
        val p3 = Resources.getInstance().factoryP2Small
    } else if(playerList.size>2 && playerList.get(2)==3) {
        val p3 = Resources.getInstance().factoryP3Small
    } else if(playerList.size>2 && playerList.get(2)==4) {
        val p3 = Resources.getInstance().factoryP4Small		
    }

    if(playerList.size>3 && playerList.get(3)==1) {
        val p4 = Resources.getInstance().factoryP1Small
    } else if(playerList.size>3 && playerList.get(3)==2) {
        val p4 = Resources.getInstance().factoryP2Small
    } else if(playerList.size>3 && playerList.get(3)==3) {
        val p4 = Resources.getInstance().factoryP3Small
    } else if(playerList.size>3 && playerList.get(3)==4) {
        val p4 = Resources.getInstance().factoryP4Small		
    }
    ...
    for(int i=0i<playerList.size;++i) {
